...
class LetterAndControlServiceSpec extends UnitSpec with WithFakeApplication with ScalaFutures {
  ...
  val taxPayerData = Table(
    ...
    (englishTaxPayer, None, None, "1 English Address"),
    (welshTaxPayer, None, None, "1 Welsh Address"),
    (northernIrelandTaxpayer, None, None, "1 Northern Ireland Address"),
    ...
    (taxPayerWithMultipleEnglishAddress, None, None, "multiple English addresses"),
    (taxPayerWithEnglishAndScottishAddress, Some("1"), Some("address-jurisdiction-conflict"), "an English and Scottish address"),
    (taxPayerWithEnglishAndForeignAddress, None, None, "an English and Foreign address"),
    (taxPayerWithScottishAndForeignAddress, Some("1"), Some("address-jurisdiction-conflict"), "a Scottish and Foreign address"),
    (taxPayerWithEnglishScottishAndForeignAddress, Some("1"), Some("address-jurisdiction-conflict"), "an English, Scottish and Foreign address"),
